...
const ComNavCategory = class {
  constructor(hostRef) {
    ...
    this.wcsCategoryItemClicked = createEvent(this, "wcsCategoryItemClicked", 7);
...
export { ComNavCategory as wcs_com_nav_category };

//# sourceMappingURL=wcs-com-nav-category.entry.js.map