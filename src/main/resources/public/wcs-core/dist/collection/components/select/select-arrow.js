...
export const SelectArrow = ({ up, ariaLabel }) => (h("svg", { "aria-hidden": ariaLabel ? false : "true", role: "img", "aria-label": ariaLabel ? ariaLabel : false, style: { marginLeft: 'auto' }, xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24" }, h("style", { type: "text/css" }, `
            .arrow-group {
