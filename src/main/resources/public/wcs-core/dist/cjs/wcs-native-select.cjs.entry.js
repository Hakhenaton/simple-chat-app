...
const NativeSelect = class {
  ...
  render() {
    return (index.h(index.Host, { class: `${this.expanded ? 'expanded' : ''}`, "data-disabled": this.disabled, "data-size": this.size }, index.h("div", { class: "select-wrapper" }, index.h("slot", null), index.h("div", { class: "arrow-container" }, index.h(selectArrow.SelectArrow, { up: this.expanded })))));
  }
  get el() { return index.getElement(this); }
};
NativeSelect.style = nativeSelectCss;

exports.wcs_native_select = NativeSelect;

//# sourceMappingURL=wcs-native-select.cjs.entry.js.map