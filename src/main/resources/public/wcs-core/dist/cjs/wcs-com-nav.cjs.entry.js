...
const ComNav = class {
  ...
  componentWillLoad() {
    ...
    comNavUtils.registerCloseHandlerForFocusOutEventOn(slottedNavigableItems, WCS_COM_NAV_SUBMENU_TAG_NAME);
  }
  componentDidRender() {
  ...
  //endregion
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "container" }, index.h("div", { class: "container-left" }, index.h("div", { class: "app-name" }, this.appName, index.h("slot", { name: "app-name" })), index.h("div", { class: "menu-bar" }, this.currentActiveSizing === 'desktop' ? index.h("slot", null) : null)), index.h("div", { class: "container-right" }, index.h("slot", { name: "actions" }), index.h("span", { id: "mobile-menu-icon", tabindex: 0, "data-mobile-open": this.mobileMenuOpen, onClick: () => this.mobileMenuIconClick(), onKeyDown: evt => this.mobileMenuIconOnKeyDown(evt) }))), index.h("div", { class: "mobile-overlay", "data-mobile-open": this.mobileMenuOpen }, this.currentActiveSizing === 'mobile' ? index.h("slot", null) : null)));
  }
  /**
...
exports.wcs_com_nav = ComNav;

//# sourceMappingURL=wcs-com-nav.cjs.entry.js.map