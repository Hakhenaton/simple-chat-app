...
const ComNavSubmenu = class {
  constructor(hostRef) {
    ...
    this.wcsClickOnFinalAction = index.createEvent(this, "wcsClickOnFinalAction", 7);
  ...
  render() {
    return (index.h(index.Host, { onClick: evt => this.onClick(evt) }, index.h("div", { tabindex: screen.width < 576 ? "-1" : "0", onClick: _ => this.menuOpen = !this.menuOpen, onKeyDown: evt => this.handleMenuKeyDown(evt), class: "menu-button" }, index.h("span", { class: "label" }, this.label), index.h("span", { class: "arrow-container" }, index.h("span", { class: "arrow-icon", "data-open": this.menuOpen }, "\uF107"))), index.h("div", { class: "drawer", "data-open": this.menuOpen, tabIndex: -1 }, index.h("div", { class: "drawer-container" }, index.h("div", { class: "drawer-content" }, index.h("div", { class: "drawer-description" }, index.h("h3", null, this.panelTitle), index.h("p", null, this.panelDescription)), index.h("div", { class: "menu-items", onClick: (evt) => this.handleMenuItemsClick(evt), onKeyDown: evt => this.handleMenuItemsKeyDown(evt) }, index.h("slot", null)))))));
  }
